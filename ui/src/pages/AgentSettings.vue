...
import AgentFiles from "../components/agents/AgentFiles.vue";
import AgentTools from "../components/agents/AgentTools.vue";
import AgentSkills from "../components/agents/AgentSkills.vue";
import AgentContacts from "../components/agents/AgentContacts.vue";

const agentsStore = useAgentsStore();
const { selectedAgent, dirty } = storeToRefs(agentsStore);
    ...
    <div class="agents-layout">
      ...
      <section class="agents-main">
        <template v-if="selectedAgent">
          ...
          <section
            v-else-if="agentsStore.activeTab === 'channels'"
            class="card"
          >
