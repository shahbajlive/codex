    ...
    <section class="agents-main">
      <template v-if="selectedAgent">
        ...
        <section
          ...
          class="panel-content"
        >
          <div class="instructions-tabs" v-if="workspaceFiles.length > 0">
            <button
              class="tab-btn"
              :class="{ active: selectedInstructionTab === 'config' }"
              @click="selectedInstructionTab = 'config'"
            >
              Config
            </button>
            <button
              ...
              @click="selectedInstructionTab = file.filename"
            >
              {{ file.filename }}
            </button>
          </div>
          ...
          <div class="instructions-header">
            <div class="info-label">
              {{
                selectedInstructionTab === "config"
                  ? "System Instructions"
                  : selectedInstructionTab
              }}
            </div>
          ...
          <template v-if="isEditing && selectedInstructionTab === 'config'">
            <textarea
          ...
          <template v-else>
            <pre class="instructions-content">{{
              selectedInstructionTab === "config"
                ? selectedAgentConfig?.developerInstructions ||
                  "No instructions configured"
                : workspaceFiles.find(
                    (f) => f.filename === selectedInstructionTab,
                  )?.content || ""
            }}</pre>
          </template>
        </section>

        <section v-else-if="activePanel === 'tools'" class="panel-content">
