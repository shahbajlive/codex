...
const queuedDrawerExpanded = ref(true);
...
<template>
  <div
    class="workspace-chat__composer-shell"
    :class="{
      'workspace-chat__composer-shell--stacked': queuedMessages.length,
    }"
  >
    <WorkspaceQueuedMessagesDrawer
    ...
    <form
      class="workspace-chat__composer"
      :class="{ 'workspace-chat__composer--attached': queuedMessages.length }"
