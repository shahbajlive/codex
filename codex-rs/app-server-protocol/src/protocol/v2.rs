...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadPendingInputItem {
    pub index: u32,
    pub text: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadPendingInputReadParams {
    pub thread_id: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadPendingInputReadResponse {
    pub thread_id: String,
    pub pending_input: Vec<ThreadPendingInputItem>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadPendingInputDeleteParams {
    pub thread_id: String,
    pub index: u32,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadPendingInputDeleteResponse {
    pub thread_id: String,
    pub pending_input: Vec<ThreadPendingInputItem>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadPendingInputUpdatedNotification {
    pub thread_id: String,
    pub pending_input: Vec<ThreadPendingInputItem>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadTurnQueueUpdatedNotification {
    pub thread_id: String,
    pub queue: Vec<ThreadTurnQueueItem>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadTurnQueueItem {
    pub index: u32,
    pub text: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadTurnQueueReadParams {
    pub thread_id: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadTurnQueueReadResponse {
    pub thread_id: String,
    pub queue: Vec<ThreadTurnQueueItem>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadTurnQueueDeleteParams {
    pub thread_id: String,
    pub index: u32,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadTurnQueueDeleteResponse {
    pub thread_id: String,
    pub queue: Vec<ThreadTurnQueueItem>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadTurnQueueUpdateParams {
    pub thread_id: String,
    pub index: u32,
    pub text: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadTurnQueueUpdateResponse {
    pub thread_id: String,
    pub queue: Vec<ThreadTurnQueueItem>,
}
