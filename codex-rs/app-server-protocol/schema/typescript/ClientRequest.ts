...
import type { AgentCreateParams } from "./v2/AgentCreateParams";
...
import type { AgentUpdateParams } from "./v2/AgentUpdateParams";
import type { AgentWorkspaceFilesParams } from "./v2/AgentWorkspaceFilesParams";
import type { AgentWorkspaceFilesUpdateParams } from "./v2/AgentWorkspaceFilesUpdateParams";
...
import type { ContactCreateParams } from "./v2/ContactCreateParams";
import type { ContactDeleteParams } from "./v2/ContactDeleteParams";
...
import type { ThreadPendingInputDeleteParams } from "./v2/ThreadPendingInputDeleteParams";
import type { ThreadPendingInputReadParams } from "./v2/ThreadPendingInputReadParams";
...
import type { ThreadTurnQueueDeleteParams } from "./v2/ThreadTurnQueueDeleteParams";
import type { ThreadTurnQueueReadParams } from "./v2/ThreadTurnQueueReadParams";
import type { ThreadTurnQueueUpdateParams } from "./v2/ThreadTurnQueueUpdateParams";
 ...
 */
export type ClientRequest ={ "method": "initialize", id: RequestId, params: InitializeParams, } | { "method": "thread/start", id: RequestId, params: ThreadStartParams, } | { "method": "thread/resume", id: RequestId, params: ThreadResumeParams, } | { "method": "thread/fork", id: RequestId, params: ThreadForkParams, } | { "method": "thread/archive", id: RequestId, params: ThreadArchiveParams, } | { "method": "thread/unsubscribe", id: RequestId, params: ThreadUnsubscribeParams, } | { "method": "thread/name/set", id: RequestId, params: ThreadSetNameParams, } | { "method": "thread/metadata/update", id: RequestId, params: ThreadMetadataUpdateParams, } | { "method": "thread/unarchive", id: RequestId, params: ThreadUnarchiveParams, } | { "method": "thread/compact/start", id: RequestId, params: ThreadCompactStartParams, } | { "method": "thread/shellCommand", id: RequestId, params: ThreadShellCommandParams, } | { "method": "thread/rollback", id: RequestId, params: ThreadRollbackParams, } | { "method": "thread/list", id: RequestId, params: ThreadListParams, } | { "method": "thread/loaded/list", id: RequestId, params: ThreadLoadedListParams, } | { "method": "thread/read", id: RequestId, params: ThreadReadParams, } | { "method": "thread/pendingInput/read", id: RequestId, params: ThreadPendingInputReadParams, } | { "method": "thread/pendingInput/delete", id: RequestId, params: ThreadPendingInputDeleteParams, } | { "method": "thread/turnQueue/read", id: RequestId, params: ThreadTurnQueueReadParams, } | { "method": "thread/turnQueue/delete", id: RequestId, params: ThreadTurnQueueDeleteParams, } | { "method": "thread/turnQueue/update", id: RequestId, params: ThreadTurnQueueUpdateParams, } | { "method": "skills/list", id: RequestId, params: SkillsListParams, } | { "method": "contact/list", id: RequestId, params: null, } | { "method": "contact/create", id: RequestId, params: ContactCreateParams, } | { "method": "contact/delete", id: RequestId, params: ContactDeleteParams, } | { "method": "plugin/list", id: RequestId, params: PluginListParams, } | { "method": "plugin/read", id: RequestId, params: PluginReadParams, } | { "method": "app/list", id: RequestId, params: AppsListParams, } | { "method": "fs/readFile", id: RequestId, params: FsReadFileParams, } | { "method": "fs/writeFile", id: RequestId, params: FsWriteFileParams, } | { "method": "fs/createDirectory", id: RequestId, params: FsCreateDirectoryParams, } | { "method": "fs/getMetadata", id: RequestId, params: FsGetMetadataParams, } | { "method": "fs/readDirectory", id: RequestId, params: FsReadDirectoryParams, } | { "method": "fs/remove", id: RequestId, params: FsRemoveParams, } | { "method": "fs/copy", id: RequestId, params: FsCopyParams, } | { "method": "skills/config/write", id: RequestId, params: SkillsConfigWriteParams, } | { "method": "plugin/install", id: RequestId, params: PluginInstallParams, } | { "method": "plugin/uninstall", id: RequestId, params: PluginUninstallParams, } | { "method": "turn/start", id: RequestId, params: TurnStartParams, } | { "method": "turn/steer", id: RequestId, params: TurnSteerParams, } | { "method": "turn/interrupt", id: RequestId, params: TurnInterruptParams, } | { "method": "review/start", id: RequestId, params: ReviewStartParams, } | { "method": "model/list", id: RequestId, params: ModelListParams, } | { "method": "experimentalFeature/list", id: RequestId, params: ExperimentalFeatureListParams, } | { "method": "mcpServer/oauth/login", id: RequestId, params: McpServerOauthLoginParams, } | { "method": "config/mcpServer/reload", id: RequestId, params: undefined, } | { "method": "mcpServerStatus/list", id: RequestId, params: ListMcpServerStatusParams, } | { "method": "windowsSandbox/setupStart", id: RequestId, params: WindowsSandboxSetupStartParams, } | { "method": "account/login/start", id: RequestId, params: LoginAccountParams, } | { "method": "account/login/cancel", id: RequestId, params: CancelLoginAccountParams, } | { "method": "account/logout", id: RequestId, params: undefined, } | { "method": "account/rateLimits/read", id: RequestId, params: undefined, } | { "method": "feedback/upload", id: RequestId, params: FeedbackUploadParams, } | { "method": "command/exec", id: RequestId, params: CommandExecParams, } | { "method": "command/exec/write", id: RequestId, params: CommandExecWriteParams, } | { "method": "command/exec/terminate", id: RequestId, params: CommandExecTerminateParams, } | { "method": "command/exec/resize", id: RequestId, params: CommandExecResizeParams, } | { "method": "config/read", id: RequestId, params: ConfigReadParams, } | { "method": "config/providers", id: RequestId, params: undefined, } | { "method": "externalAgentConfig/detect", id: RequestId, params: ExternalAgentConfigDetectParams, } | { "method": "externalAgentConfig/import", id: RequestId, params: ExternalAgentConfigImportParams, } | { "method": "config/value/write", id: RequestId, params: ConfigValueWriteParams, } | { "method": "config/batchWrite", id: RequestId, params: ConfigBatchWriteParams, } | { "method": "agent/list", id: RequestId, params: AgentListParams, } | { "method": "agent/read", id: RequestId, params: AgentReadParams, } | { "method": "agent/update", id: RequestId, params: AgentUpdateParams, } | { "method": "agent/create", id: RequestId, params: AgentCreateParams, } | { "method": "agent/delete", id: RequestId, params: AgentDeleteParams, } | { "method": "agent/listIsolated", id: RequestId, params: AgentListParams, } | { "method": "agent/readIsolated", id: RequestId, params: AgentReadParams, } | { "method": "agent/updateIsolated", id: RequestId, params: AgentUpdateParams, } | { "method": "agent/workspaceFiles", id: RequestId, params: AgentWorkspaceFilesParams, } | { "method": "agent/workspaceFiles/update", id: RequestId, params: AgentWorkspaceFilesUpdateParams, } | { "method": "configRequirements/read", id: RequestId, params: undefined, } | { "method": "account/read", id: RequestId, params: GetAccountParams, } | { "method": "getConversationSummary", id: RequestId, params: GetConversationSummaryParams, } | { "method": "gitDiffToRemote", id: RequestId, params: GitDiffToRemoteParams, } | { "method": "getAuthStatus", id: RequestId, params: GetAuthStatusParams, } | { "method": "fuzzyFileSearch", id: RequestId, params: FuzzyFileSearchParams, };
